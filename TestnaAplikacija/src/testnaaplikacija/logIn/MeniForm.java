...
public class MeniForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.getAccessibleContext().setAccessibleName("Rad");

        jMenuItem2.setText("Pomoc");
        jMenu2.add(jMenuItem2);
        jMenuItem2.getAccessibleContext().setAccessibleName("Pomoc");
        ...
        jMenuItem3.getAccessibleContext().setAccessibleName("Odjava");
